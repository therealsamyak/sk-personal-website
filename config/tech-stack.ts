...
export const technologies: TechCategory[] = [
  ...
  },
  {
    ...
    skills: ["Node.js", "PostgreSQL", "MySQL", "Snowflake", "Supabase", "Convex", "Clerk"],
    color: "red",
  },
  {
    category: "Hardware & Embedded",
    skills: ["ESP32", "PlatformIO", "Jetson Nano", "IoT Systems", "SDL"],
    color: "indigo",
  },
  {
    category: "Infrastructure & Cloud",
    skills: ["AWS", "Cloudflare", "Vercel", "Docker", "GitHub CI/CD"],
    color: "orange",
  },
  {
    category: "Languages",
